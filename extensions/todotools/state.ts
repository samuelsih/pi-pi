...
import { isRecord, isTodoStateEntry, isTodoWriteDetails } from "./guards";

export { isRecord, isTodoItem, isTodoItemArray, isTodoStateEntry, isTodoWriteDetails } from "./guards";
...
export const TODO_STATE_ENTRY_TYPE = "pi-todo.todo-state";
